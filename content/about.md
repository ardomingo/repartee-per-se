...
This site is built using R, RStudio, Hugo, and the `{blogdown}` package for R.  The code for each post is available on the website GitHub repository at https://github.com/ardomingo/repartee-per-se.
